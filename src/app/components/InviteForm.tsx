...
export default function InviteForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="email" className="block text-sm font-bold text-[#ffe066] mb-1">
          Email
        </label>
        <input
          type="email"
      ...
      <div>
        <label htmlFor="name" className="block text-sm font-bold text-[#ffe066] mb-1">
          Name
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-bold text-[#ffe066] mb-1">
          Message
        </label>
        <textarea
          id="message"
      ...
      {status === 'success' && (
        <p className="text-green-400 text-center font-bold">Invitation sent successfully!</p>
      )}
      {status === 'error' && (
        <p className="text-red-400 text-center font-bold">Failed to send invitation. Please try again.</p>
      )}
    </form>
  );
} 